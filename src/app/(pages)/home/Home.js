    ...
    <main className="bg-white min-h-screen overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 w-full py-12 lg:py-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              ...
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed max-w-lg mx-auto lg:mx-0">
              ...
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3 pt-2">
                <Link href="/contact">
                  <button 
                    className="bg-[#193d84] hover:bg-[#0b1220] text-white text-sm font-semibold px-6 py-2.5 rounded-full transition-all duration-300 hover:shadow-lg hover:scale-105 flex items-center gap-2 focus:outline-none"
                ...
                <Link href="/solutions">
                  <button 
                    className="text-black hover:text-[#193d84] text-sm font-medium px-5 py-2.5 rounded-full transition-all duration-300 flex items-center gap-2 focus:outline-none"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
            {[
              ...
              >
                <stat.icon size={28} className="text-[#193d84] mx-auto mb-2 sm:mb-3" />
                <p className="text-2xl sm:text-3xl md:text-4xl font-bold text-black">{stat.number}</p>
            ...
            {[
              ...
              >
                <Link href={service.link}>
                  ...
                  <div className="p-4 sm:p-6 transition-all duration-300 group-hover:bg-[#193d84]/[0.03]">
                    <h3 className="text-lg sm:text-xl font-bold text-black mb-2 transition-colors duration-300 group-hover:text-[#193d84]">
                      {service.title}
                    </h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-3 sm:gap-4 mt-6 max-w-md mx-auto lg:mx-0">
                {[
                  'Expert Team',
                  'Global Reach',
                  'Innovation Driven',
              ...
              <Link href="/about">
                <button 
                  className="mt-6 bg-[#193d84] hover:bg-[#0b1220] text-white text-sm sm:text-base font-semibold px-6 sm:px-8 py-2.5 sm:py-3 rounded-full transition-all duration-300 hover:shadow-xl hover:scale-105 flex items-center gap-2 mx-auto lg:mx-0 focus:outline-none"
                  aria-label="Learn more about NexaSphere Tech"
                >
                  Learn More About Us
                  <ArrowRight size={20} />
                </button>
      ...
      <section className="w-full bg-white py-16 sm:py-20 lg:py-24 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 relative">
          ...
          <div className="absolute -top-6 left-0 z-20 w-20 sm:w-28 md:w-32 lg:w-48">
            <Image
          ...
          <div className="grid gap-4 sm:gap-6 md:gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <motion.div
                ...
                className="group relative rounded-2xl bg-white p-5 sm:p-6 lg:p-7 shadow-lg transition-all duration-300 hover:-translate-y-3 hover:shadow-2xl overflow-hidden cursor-pointer border border-gray-100/50"
              >
                <Link href={item.link}>
                  ...
                  <div className="relative z-10">
                    <div className="mb-4 sm:mb-5 inline-flex h-14 w-14 sm:h-16 sm:w-16 items-center justify-center rounded-2xl transition-all duration-300 group-hover:scale-110 group-hover:rotate-3 bg-gradient-to-br from-[#193d84]/10 to-[#2a5a9e]/10 text-[#193d84] group-hover:bg-gradient-to-br group-hover:from-[#193d84] group-hover:to-[#2a5a9e] group-hover:text-white group-hover:shadow-lg group-hover:shadow-[#193d84]/25">
                      <item.icon size={22} className="transition-all duration-300 group-hover:scale-110" />
                    </div>
                  </div>

                  <h3 className="relative z-10 mb-2 text-base sm:text-lg font-bold text-black transition-all duration-300 group-hover:text-[#193d84]">
                    {item.title}
                  </h3>
          ...
          >
            <Link
              href="/services"
              className="group relative inline-flex items-center justify-center overflow-hidden bg-[#193d84] hover:bg-[#0b1220] text-white font-semibold text-sm sm:text-base px-6 sm:px-8 py-3 sm:py-3.5 rounded-full shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-105 border border-white/40 focus:outline-none"
      ...
      <section className="w-full bg-[#f0f4ff] py-16 sm:py-20 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
          ...
          <div className="relative overflow-hidden pb-8">
            ...
            <motion.div 
              className="testimonial-track flex gap-4 sm:gap-6 lg:gap-8 cursor-grab active:cursor-grabbing"
              drag="x"
            ...
            >
              ...
              {testimonials.map((testimonial) => (
                <div 
                  key={testimonial.id}
                  className="min-w-[280px] sm:min-w-[300px] md:min-w-[340px] lg:min-w-[380px] bg-white rounded-2xl p-5 sm:p-6 lg:p-8 shadow-lg border border-gray-100 select-none hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
                >
                  <div className="flex items-center gap-3 sm:gap-4 mb-4">
                    <div className="relative w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-full overflow-hidden bg-gray-200 flex-shrink-0">
                      <Image
                    ...
                    <div>
                      <h4 className="font-bold text-base sm:text-lg text-black">{testimonial.name}</h4>
                      <p className="text-xs sm:text-sm font-semibold text-[#193d84]">{testimonial.company}</p>
                    </div>
                  </div>
                  <div className="relative">
                    <span className="text-3xl sm:text-4xl text-[#193d84]/20 absolute -top-2 -left-2">"</span>
                    <p className="text-sm sm:text-base text-gray-600 leading-relaxed pl-4 sm:pl-6 relative z-10">
                      {testimonial.text}
                    </p>
                  </div>
                  <div className="flex items-center gap-1 mt-4">
                    {[...Array(5)].map((_, i) => (
                      <svg key={i} className="w-4 h-4 sm:w-5 sm:h-5 text-[#193d84] fill-current" viewBox="0 0 24 24">
